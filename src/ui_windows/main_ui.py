...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaOpen.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        ...
        self.scrollAreaInProgress.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        ...
        self.scrollAreaStuckTest.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        ...
        self.scrollAreaDone.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        ...
        self.scrollAreaProjectsList.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
