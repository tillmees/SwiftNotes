...
class Ui_ProjectWidget(object):
    def setupUi(self, ProjectWidget):
        ...
        self.pushButtonProjectTitle = QPushButton(self.Project)
        self.pushButtonProjectTitle.setObjectName(u"pushButtonProjectTitle")
        sizePolicy2 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy2.setHorizontalStretch(0)
        sizePolicy2.setVerticalStretch(0)
        sizePolicy2.setHeightForWidth(self.pushButtonProjectTitle.sizePolicy().hasHeightForWidth())
        self.pushButtonProjectTitle.setSizePolicy(sizePolicy2)
        font = QFont()
        font.setBold(True)
        self.pushButtonProjectTitle.setFont(font)

        self.horizontalLayout.addWidget(self.pushButtonProjectTitle, 0, Qt.AlignLeft|Qt.AlignVCenter)
    ...
    def retranslateUi(self, ProjectWidget):
        ...
        self.pushButtonProjectTitle.setText(QCoreApplication.translate("ProjectWidget", u"Title", None))
